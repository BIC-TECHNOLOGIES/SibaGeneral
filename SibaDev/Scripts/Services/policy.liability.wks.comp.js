(function (s, u) {
    s.add({
        save_policy: function (liability, success, error) {
            u.post("/api/policyliabilitywkscomp/save", liability, success, error);
        },
        get_policys: function (success, error) {
            u.get("/api/policyliabilitywkscomp", success, error);
        },
        search_policy: function (query, success, error) {
            u.get("/api/policyliabilitywkscomp/search/" + query, success, error);
        }, 
