(function (s, u) {
    s.add({
        save_policy: function (policys, success, error) {
            u.post("/api/policygaprofindemnity/save", policys, success, error);
        },
        get_policys: function (success, error) {
            u.get("/api/policygaprofindemnity", success, error);
        },
        search_policy: function (query, success, error) {
            u.get("/api/policygaprofindemnity/search/" + query, success, error);
        },
        confirmPolicy: function (polId, success, error) {
            u.get("/api/Confirmation/confirmProfIndemnityPolicy/" + polId, success, error);
        },
        risk_end_deletion: function (sysID, endNo, success, error) {
            u.get("/api/policygaprofindemnity/endDeletion/" + sysID + "/" + endNo, success, error);
        },
