        ...
        $scope.liability_grid = u.default_grid("#gridLiabilityRisks", "#gridLiabilityRisksPager", "Liability Policy",
            ...
            function (sel_id) {
                ...
                u.fill_form({
                    ...
                    LIAWOC_OBJECT: grid.jqGrid('getCell', sel_id, 'LIAWOC_OBJECT'),
                    LIAWOC_OBJECT_NAME: grid.jqGrid('getCell', sel_id, 'LIAWOC_OBJECT_NAME'),
                    LIAWOC_ADDRESS: grid.jqGrid('getCell', sel_id, 'LIAWOC_ADDRESS'),
                    LIAWOC_FLOATER: grid.jqGrid('getCell', sel_id, 'LIAWOC_FLOATER'),
                    LIAWOC_PERIOD_DAYS: grid.jqGrid('getCell', sel_id, 'LIAWOC_PERIOD_DAYS'),
                    LIAWOC_RISK_NO: grid.jqGrid('getCell', sel_id, 'LIAWOC_RISK_NO'),

                    LIAWOC_NO_PERSONS: grid.jqGrid('getCell', sel_id, 'LIAWOC_NO_PERSONS'),
                    LIAWOC_NO_YEARS: grid.jqGrid('getCell', sel_id, 'LIAWOC_NO_YEARS'),
                    LIAWOC_GEO_LIM: grid.jqGrid('getCell', sel_id, 'LIAWOC_ADDRESS'),
                    LIAWOC_FLOATER: grid.jqGrid('getCell', sel_id, 'LIAWOC_GEO_LIM'),
                    LIAWOC_SAL_SLAB: grid.jqGrid('getCell', sel_id, 'LIAWOC_SAL_SLAB'),
                    LIAWOC_SAL_MONTH: grid.jqGrid('getCell', sel_id, 'LIAWOC_SAL_MONTH'),

                    LIAWOC_ADD_MONTH_BENF: grid.jqGrid('getCell', sel_id, 'LIAWOC_ADD_MONTH_BENF'),
                    LIAWOC_LABR_TYPE: grid.jqGrid('getCell', sel_id, 'LIAWOC_LABR_TYPE'),
                    LIAWOC_ANN_WAGES_FC: grid.jqGrid('getCell', sel_id, 'LIAWOC_ANN_WAGES_FC'),
                    LIAWOC_ANN_WAGES_BC: grid.jqGrid('getCell', sel_id, 'LIAWOC_ANN_WAGES_BC'),

                    LIAWOC_PREMIUM_FC: grid.jqGrid('getCell', sel_id, 'LIAWOC_PREMIUM_FC'),
                    LIAWOC_PREMIUM_BC: grid.jqGrid('getCell', sel_id, 'LIAWOC_PREMIUM_BC'),
       ...
       *------------------------------------------------*/
        ...
        *----------------------------------*/
        ...
        $("#btn_open_liab_risk").click(function () {
            if (u.form_validation("#polheaderForm")) {
                $("#LiabilityModal").modal();
                $("#POLH_SUB_CLASS_CODE").val($("#LIAWOC_OBJECT").val());
                $("#PDT_NAME").val($("#LIAWOC_OBJECT_NAME").val());
        ...
        *----------------------------------*/
        ...
        $("#btn_agent_comm").click(function () {
            ...
            if (u.grid_empty($scope.liability_grid)) return u.modal_alert("Worksmen Compensation Liability Grid is empty!!!");
                    ...
                    s.save_policy(polhData, function (responseData) {
                        ...
                        if (responseData.state) {
                            ...
                            for (var i = 0; i < riskRowIds.length; i++) {
                                covRecStatus = $scope.liability_grid.jqGrid("getCell", riskRowIds[i], "LIAWOC_STATUS");
                                ...
                                if (covRecStatus === "U") {
                                    $scope.liability_grid.jqGrid("setCell", riskRowIds[i], "LIAWOC_STATUS", "A");
                                }
                            }
            ...
            u.modal_confirmation("Are you sure you want to pass an endorsement on the Policy?", function (e) {
               ...
               // alert("Y");
                ...
                for (var i = 0; i < riskRowIds.length; i++) {
                    ...
                    $scope.liability_grid.jqGrid("setCell", riskRowIds[i], "LIAWOC_POLH_END_NO", endNo);
                }
                //Risk Covers
       ...
       *-------------------------*/
        ...
        *------------------*/
        ...
        $scope.search_fill = function (policy) {
            ...
            if (policy.INS_UDW_LIABILITY_WKS_COMP) {
            ...
            //populate risk covers with covers from the Liability worksmen and not the policy header
            u.clear_grid_data($scope.cover_grid);
            for (var x in policy.INS_UDW_LIABILITY_WKS_COMP[i].INS_UWD_RISK_COVERS) {
                //get Cover Names
                policy.INS_UDW_LIABILITY_WKS_COMP[i].INS_UWD_RISK_COVERS[x]["RCOV_NAME"] = policy.INS_UDW_LIABILITY_WKS_COMP[i].INS_UWD_RISK_COVERS[x]["MS_UDW_COVERS"]["CVR_NAME"];
                //get Covers
