(function ($, s, u, $scope) {
    $(function () {
        ...
        $scope.location_grid = u.default_grid("#gridPLoc", "#gridPLocPager", "Location Details",
            ...
            function (sel_id) {
                ...
                u.fill_form({
                    ...
                    PLOC_REG_CODE: grid.jqGrid("getCell", sel_id, "PLOC_REG_CODE"),
                    PLOC_REG_NAME: grid.jqGrid("getCell", sel_id, "PLOC_REG_NAME"),
                ...
                u.fill_form({
                    FINW_ORIG_SI_FC: grid.jqGrid("getCell", sel_id, "PLOC_SI_FC"),
                    FINW_ORIG_SI_BC: grid.jqGrid("getCell", sel_id, "PLOC_SI_BC"),
                    FINW_ORIG_PREM_FC: grid.jqGrid("getCell", sel_id, "PLOC_TOT_PREM_FC"),
                    FINW_ORIG_PREM_BC: grid.jqGrid("getCell", sel_id, "PLOC_TOT_PREM_BC"),
                }, "#facInwardForm");

                u.fill_form({
                    FOTW_SHARE_SI_FC: grid.jqGrid("getCell", sel_id, "PLOC_SI_FC"),
                    FOTW_SHARE_SI_BC: grid.jqGrid("getCell", sel_id, "PLOC_SI_BC"),
                    FOTW_SHARE_PREM_FC: grid.jqGrid("getCell", sel_id, "PLOC_TOT_PREM_FC"),
                    FOTW_SHARE_PREM_BC: grid.jqGrid("getCell", sel_id, "PLOC_TOT_PREM_BC"),
        ...
        //Location Interest
            ...
            [
                "Risk Code", "Risk Name", " Description", "Roofing Type", "Security", "Sub Const ", "RI EML", "EML SI",
                "SI FC", "SI BC ", " Premium FC", " Premium BC ", "Loading FC", "Loading BC", "Discount FC", "Discount BC", 
                 "Sys ID", "Risk No",
            ...
            [
                    ...
                    { name: "LINT_ROOF_TYPE", index: "LINT_ROOF_TYPE", width: 150 },
                    { name: "LINT_SEC_TYPE", index: "LINT_SEC_TYPE", width: 150 },
           ...
           //Retrive Grid data into form input fields on row click..
               function (sel_id) {
                   ...
                   u.fill_form({
                       ...
                       RCOV_NAME: grid.jqGrid("getCell", sel_id, "RCOV_NAME"),
                       ...
                       RCOV_SI_CHANGE: grid.jqGrid("getCell", sel_id, "RCOV_SI_CHANGE"),
                       RCOV_RATE_CHANGE: grid.jqGrid("getCell", sel_id, "RCOV_RATE_CHANGE"),
                       ...
                       RCOV_ANNL_PREM_FC: grid.jqGrid("getCell", sel_id, "RCOV_ANNL_PREM_FC"),
                       RCOV_ANNL_PREM_BC: grid.jqGrid("getCell", sel_id, "RCOV_ANNL_PREM_BC")
                   }, "#coverForm");
               }),
        ...
        //Intermediary Commission
           ...
           //Retrive Grid data into form input fields on row click..
            ...
            function (sel_id) {
                ...
                $("form input[name='DL_CODE']").data("update", true);
                u.fill_form({
                    CMM_INT_CODE: grid.jqGrid("getCell", sel_id, "COM_INT_CODE"),
                    CMM_INT_NAME: grid.jqGrid("getCell", sel_id, "COM_NAME"),
                    CMM_COM_PERC: grid.jqGrid("getCell", sel_id, "COM_DFT_PERC"),
        ...
        $scope.grdfacInward_grid = u.default_grid("#grdfacInward", "#grdfacInwardPager", "FAC Inward Details",
            ["Cedant Code", "Cedant Name", "Referential No.", "Acceptance No.", "Comment", "Original SI FC", "Original SI BC",
             ...
             "Created by", "Created date", "Status", "Company"],
            [
           ...
           //Retrive Grid data into form input fields on row click..
            function (sel_id) {
                ...
                u.fill_form({
                    FINW_CEDANT_CODE: grid.jqGrid("getCell", sel_id, "FINW_CEDANT_CODE"),
                    FINW_CEDANT_NAME: grid.jqGrid("getCell", sel_id, "FINW_CEDANT_NAME"),
                    FINW_ORIG_SI_FC: grid.jqGrid("getCell", sel_id, "FINW_ORIG_SI_FC"),

                    FINW_REF_NO: grid.jqGrid("getCell", sel_id, "FINW_REF_NO"),
                    FINW_ACCPT_NO: grid.jqGrid("getCell", sel_id, "FINW_ACCPT_NO"),
                    FINW_COMMENT: grid.jqGrid("getCell", sel_id, "FINW_COMMENT"),

                    FINW_ORIG_SI_BC: grid.jqGrid("getCell", sel_id, "FINW_ORIG_SI_BC"),
                    FINW_ORIG_PREM_FC: grid.jqGrid("getCell", sel_id, "FINW_ORIG_PREM_FC"),
                    FINW_ORIG_PREM_BC: grid.jqGrid("getCell", sel_id, "FINW_ORIG_PREM_BC"),
                    FINW_SHARE_PERC: grid.jqGrid("getCell", sel_id, "FINW_SHARE_PERC"),

                    FINW_COMM_PERC: grid.jqGrid("getCell", sel_id, "FINW_COMM_PERC"),
                    FINW_SI_FC: grid.jqGrid("getCell", sel_id, "FINW_SI_FC"),
                    FINW_SI_BC: grid.jqGrid("getCell", sel_id, "FINW_SI_BC"),
                    FINW_PREM_BC: grid.jqGrid("getCell", sel_id, "FINW_PREM_BC"),
                    FINW_PREM_FC: grid.jqGrid("getCell", sel_id, "FINW_PREM_FC"),
                    FINW_COMM_FC: grid.jqGrid("getCell", sel_id, "FINW_COMM_FC"),
                    FINW_COMM_BC: grid.jqGrid("getCell", sel_id, "FINW_COMM_BC"),

                }, "#facInwardForm");

                u.fill_form({

                    FINW_PAP_FINW_SYS_ID: grid.jqGrid("getCell", sel_id, "FINW_SYS_ID"),
        ...
        $scope.grdInwdParticipant_grid = u.default_grid("#grdInwdParticipants", "#grdInwdParticipantsPager", "FAC Inward Details",
           ...
           //Retrive Grid data into form input fields on row click..
            function (sel_id) {
                ...
                u.fill_form({
                    FINW_PAP_CODE: grid.jqGrid("getCell", sel_id, "FINW_PAP_CODE"),
                    FINW_PAP_NAME: grid.jqGrid("getCell", sel_id, "FINW_PAP_NAME"),
                    FINW_PAP_SHARE_PERC: grid.jqGrid("getCell", sel_id, "FINW_PAP_SHARE_PERC"),
                    FINW_PAP_SHARE_SI: grid.jqGrid("getCell", sel_id, "FINW_PAP_SHARE_SI"),
                    FINW_PAP_SHARE_PREM: grid.jqGrid("getCell", sel_id, "FINW_PAP_SHARE_PREM"),
        ...
        $scope.grdCoinsLeader_grid = u.default_grid("#grdCoinsLeader", "#grdCoinsLeaderPager", "FAC Inward Details",
           ...
           //Retrive Grid data into form input fields on row click..
            function (sel_id) {
                ...
                u.fill_form({
                    FOTW_SHARE_PERC: grid.jqGrid("getCell", sel_id, "FOTW_SHARE_PERC"),
                    FOTW_MEM_SHARE_PERC: grid.jqGrid("getCell", sel_id, "FOTW_MEM_SHARE_PERC"),
                    FOTW_SHARE_SI_FC: grid.jqGrid("getCell", sel_id, "FOTW_SHARE_SI_FC"),
                    FOTW_SHARE_SI_BC: grid.jqGrid("getCell", sel_id, "FOTW_SHARE_SI_BC"),
                    FOTW_SHARE_PREM_FC: grid.jqGrid("getCell", sel_id, "FOTW_SHARE_PREM_FC"),
                    FOTW_SHARE_PREM_BC: grid.jqGrid("getCell", sel_id, "FOTW_SHARE_PREM_BC"),
                    FOTW_MEM_SI_FC: grid.jqGrid("getCell", sel_id, "FOTW_MEM_SI_FC"),

                    FOTW_MEM_SI_BC: grid.jqGrid("getCell", sel_id, "FOTW_MEM_SI_BC"),
                    FOTW_MEM_PREM_FC: grid.jqGrid("getCell", sel_id, "FOTW_MEM_PREM_FC"),
                    FOTW_MEM_PREM_BC: grid.jqGrid("getCell", sel_id, "FOTW_MEM_PREM_BC"),
                    FOTW_RI_MEM_CODE: grid.jqGrid("getCell", sel_id, "FOTW_RI_MEM_CODE"),

                    FOTW_RI_MEM_NAME: grid.jqGrid("getCell", sel_id, "FOTW_RI_MEM_NAME"),
                    FOTW_RI_PERC: grid.jqGrid("getCell", sel_id, "FOTW_RI_PERC"),
                    FOTW_RI_COMM: grid.jqGrid("getCell", sel_id, "FOTW_RI_COMM"),
                    FOTW_RI_SHARE_SI: grid.jqGrid("getCell", sel_id, "FOTW_RI_SHARE_SI"),
                    FOTW_RI_SHARE_PREM: grid.jqGrid("getCell", sel_id, "FOTW_RI_SHARE_PREM"),
                    FOTW_RI_SHARE_COMM: grid.jqGrid("getCell", sel_id, "FOTW_RI_SHARE_COMM"),
       ...
       *------------------------------------------------*/
        ...
        *----------------------------------*/
        ...
        $("#btn_agent_comm").click(function () {
            ...
            if (u.grid_empty($scope.interest_grid)) return u.modal_alert("Location Interest Grid is empty!!!");
        ...
        *------------------------------------------------*/
        ...
        $("#btn_risk_cover").click(function () {
            ...
            var sel_id = grid.jqGrid("getGridParam", "selrow");
            var intRiskId = grid.jqGrid("getCell", sel_id, "LINT_SYS_ID");
...
*------------------------------------------------*/
       ...
       */
        $scope.hideShowLocInt = function () {
            ...
            var sel_id = locgrid.jqGrid("getGridParam", "selrow");
            var locRiskId = locgrid.jqGrid("getCell", sel_id, "PLOC_SYS_ID");
...
*------------------------------------------------*/
        ...
        $("#btnEndorse").on('click', function () {
            u.modal_confirmation("Are you sure you want to pass an endorsement on the Policy?", function (e) {
                ...
                for (var i = 0; i < locationRowIds.length; i++) {
                    ...
                    $scope.location_grid.jqGrid("setCell", locationRowIds[i], "PLOC_POLH_END_NO", endNo);
                }
                //Location Interest
                for (var i = 0; i < InterestRowIds.length; i++) {

                    $scope.interest_grid.jqGrid("setCell", InterestRowIds[i], "LINT_POLH_DOC_NO", endNo);
                }
                //Risk Covers
                for (var j = 0; j < coverRowIds.length; j++) {

                    $scope.interest_grid.jqGrid("setCell", coverRowIds[j], "RPCOV_END_NO", endNo);
                }
                //Commissions
                ...
                for (var m = 0; m < riskFeesIds.length; m++) {
                    ...
                    $scope.riskFees_grid.jqGrid("setCell", riskFeesIds[m], "FIRE_FEE_END_NO", endNo);
                }
                //Pol fees summary
       ...
       *-------------------------*/
        ...
        $scope.search_fill = function (policy) {
            ...
            if (policy.INS_UWD_FIRE_LOCRISK) {
            ...
            //populate risk covers with covers from the Fire Location Interest and not the policy header 
            u.clear_grid_data($scope.cover_grid);
            for (var x in policy.INS_UWD_FIRE_LOCINT[i].INS_UWD_RISK_COVERS) {
                //get Cover Names
                policy.INS_UWD_FIRE_LOCINT[i].INS_UWD_RISK_COVERS[x]["RCOV_NAME"] = policy.INS_UWD_FIRE_LOCINT[i].INS_UWD_RISK_COVERS[x]["MS_UDW_COVERS"]["CVR_NAME"];
                //get Covers
      ...
      *------------------------------------*/
        ...
        */
        $scope.hideShowCovers = function () {
            ...
            var sel_id = vehgrid.jqGrid("getGridParam", "selrow");
            var vehRiskId = vehgrid.jqGrid("getCell", sel_id, "LINT_SYS_ID");
