(function ($, s, u, $scope) {
    $(function () {
        ...
        // Pa Risk Grid
        $scope.pa_grid = u.default_grid("#gridPa", "#gridPaPager", " Personal Accident",
            [
            'Risk Code', 'Risk Name', 'Group ID', 'Group Name', 'Currency', 'Currency Rate', 'Start Date', 'End Date', 'Issue Date', 'Retro Date', 'Pol Days',
            'Insured Name', ' Date of Birth', 'Age', 'Gender',
            ...
            [
                ...
                { name: 'PA_RISK_CLASSNAME', index: 'PA_RISK_CLASSNAME', width: 200 },

                { name: 'PA_CURRENCY', index: 'PA_CURRENCY', width: 200 },
                { name: 'PA_CURRENCY_RATE', index: 'PA_CURRENCY_RATE', width: 200 },
                { name: 'PA_START_DATE', index: 'PA_START_DATE', width: 200 },
                { name: 'PA_END_DATE', index: 'PA_END_DATE', width: 200 },
                { name: 'PA_ISSUE_DATE', index: 'PA_ISSUE_DATE', width: 200 },
                { name: 'PA_RETRO_DATE', index: 'PA_RETRO_DATE', width: 200 },
                { name: 'PA_DAYS', index: 'PA_DAYS', width: 200 },

                { name: 'PA_GRP_ID', index: 'PA_GRP_ID', width: 200 },
                { name: 'PA_GRP_NAME', index: 'PA_GRP_NAME', width: 200 },
                { name: 'PA_NAME_INSURED', index: 'PA_NAME_INSURED', width: 200 },
                { name: 'PA_DOB', index: 'PA_DOB', width: 200 },
                { name: 'PA_AGE', index: 'PA_AGE', width: 200 },
                { name: 'PA_GENDER', index: 'PA_GENDER', width: 200 },
                { name: 'PA_NAME_NOMINEE', index: 'PA_NAME_NOMINEE', width: 200 },
                { name: 'PA_RELATION', index: 'PA_RELATION', width: 200 },
                { name: 'PA_EARNING', index: 'PA_EARNING', width: 200 },
                { name: 'PA_MONTHLY_INCOME', index: 'PA_MONTHLY_INCOME', width: 200 },
                { name: 'PA_JOB_TYPE', index: 'PA_IND_JOB_TYPE', width: 200 },
                { name: 'PA_RATE', index: 'PA_RATE', width: 200 },
                { name: 'PA_WEEKS', index: 'PA_WEEKS', width: 200 },
                { name: 'PA_WEEKLY_BENEFIT', index: 'PA_WEEKLY_BENEFIT', width: 200 },
                { name: 'PA_DESCRIPTION', index: 'PA_DESCRIPTION', width: 200 },
                { name: 'PA_EXCLUSIONS', index: 'PA_EXCLUSIONS', width: 200 },

                { name: 'PA_NUM_PERSONS', index: 'PA_NUM_PERSONS', width: 200 },
                { name: 'PA_ANN_SALARY', index: 'PA_ANN_SALARY', width: 200 },
                { name: 'PA_TFE_SALARY', index: 'PA_TFE_SALARY', width: 200 },
                { name: 'PA_LIM_EVENTS', index: 'PA_LIM_EVENTS', width: 200 },
                { name: 'PA_LIM_LIFE', index: 'PA_LIM_LIFE', width: 200 },
                { name: 'PA_OCCUPATION', index: 'PA_OCCUPATION', width: 200 },

                { name: 'PA_SI_FC', index: 'PA_SI_FC', width: 200 },
                { name: 'PA_SI_BC', index: 'PA_SI_BC', width: 200 },
                { name: 'PA_TOT_PREM_FC', index: 'PA_TOT_PREM_FC', width: 200 },
                { name: 'PA_TOT_PREM_BC', index: 'PA_TOT_PREM_BC', width: 200 },
                { name: 'PA_DISC_FC', index: 'PA_DISC_FC', width: 200 },
                { name: 'PA_DISC_BC', index: 'PA_DISC_BC', width: 200 },
                { name: 'PA_LOAD_FC', index: 'PA_LOAD_FC', width: 200 },
                { name: 'PA_LOAD_BC', index: 'PA_LOAD_BC', width: 200 },

                { name: 'PA_COMMISSION_FC', index: 'PA_COMMISSION_FC', width: 200 },
                { name: 'PA_COMMISSION_BC', index: 'PA_COMMISSION_BC', width: 200 },
                { name: 'PA_TXN_STATUS', index: 'PA_TXN_STATUS', width: 200 },
                { name: 'PA_RISK_STATE', index: 'PA_RISK_STATE', width: 200 },
                { name: 'PA_UW_YEAR', index: 'PA_UW_YEAR', width: 200 },

                { name: 'PA_CRTE_BY', index: 'PA_CRTE_BY', width: 200 },
                { name: 'PA_CRTE_DATE', index: 'PA_CRTE_DATE', width: 200 },
           ...
           //Retrive Grid data into form input fields on row click..
                   function (sel_id) {
                       ...
                       u.fill_form({
                           PA_SYS_ID: grid.jqGrid('getCell', sel_id, 'PA_SYS_ID'),
                           PA_RISK_CLASSCODE: grid.jqGrid('getCell', sel_id, 'PA_RISK_CLASSCODE'),
                           PA_RISK_CLASSNAME: grid.jqGrid('getCell', sel_id, 'PA_RISK_CLASSNAME'),
                           PA_RISK_NO: grid.jqGrid('getCell', sel_id, 'PA_RISK_NO'),
                           PA_ID: grid.jqGrid('getCell', sel_id, 'PA_ID'),
                           PA_NAME: grid.jqGrid('getCell', sel_id, 'PA_NAME'),
                           PA_NAME_INSURED: grid.jqGrid('getCell', sel_id, 'PA_NAME_INSURED'),
                           PA_DOB: grid.jqGrid('getCell', sel_id, 'PA_DOB'),
                           PA_AGE: grid.jqGrid('getCell', sel_id, 'PA_AGE'),
                           PA_GENDER: grid.jqGrid('getCell', sel_id, 'PA_GENDER'),
                           PA_NAME_NOMINEE: grid.jqGrid('getCell', sel_id, 'PA_NAME_NOMINEE'),
                           PA_RELATION: grid.jqGrid('getCell', sel_id, 'PA_RELATION'),
                           PA_EARNING: grid.jqGrid('getCell', sel_id, 'PA_EARNING'),
                           PA_MONTHLY_INCOME: grid.jqGrid('getCell', sel_id, 'PA_MONTHLY_INCOME'),
                           PA_JOB_TYPE: grid.jqGrid('getCell', sel_id, 'PA_JOB_TYPE'),
                           PA_RATE: grid.jqGrid('getCell', sel_id, 'PA_RATE'),
                           PA_EXCLUSIONS: grid.jqGrid('getCell', sel_id, 'PA_EXCLUSIONS'),
                           PA_WEEKS: grid.jqGrid('getCell', sel_id, 'PA_WEEKS'),
                           PA_WEEKLY_BENEFIT: grid.jqGrid('getCell', sel_id, 'PA_WEEKLY_BENEFIT'),
                           PA_DESCRIPTION: grid.jqGrid('getCell', sel_id, 'PA_DESCRIPTION'),
                       }, "#PaForm"),
               
                u.fill_form({
                    RCOV_RISK_SYS_ID: grid.jqGrid('getCell', sel_id, 'PA_SYS_ID'),
                }, "#coverForm");

                u.fill_form({
                    FINW_ORIG_SI_FC: grid.jqGrid("getCell", sel_id, "PA_SI_FC"),
                    FINW_ORIG_SI_BC: grid.jqGrid("getCell", sel_id, "PA_SI_BC"),
                    FINW_ORIG_PREM_FC: grid.jqGrid("getCell", sel_id, "PA_TOT_PREM_FC"),
                    FINW_ORIG_PREM_BC: grid.jqGrid("getCell", sel_id, "PA_TOT_PREM_BC"),
                }, "#facInwardForm");

                u.fill_form({
                    FOTW_SHARE_SI_FC: grid.jqGrid("getCell", sel_id, "PA_SI_FC"),
                    FOTW_SHARE_SI_BC: grid.jqGrid("getCell", sel_id, "PA_SI_BC"),
                    FOTW_SHARE_PREM_FC: grid.jqGrid("getCell", sel_id, "PA_TOT_PREM_FC"),
                    FOTW_SHARE_PREM_BC: grid.jqGrid("getCell", sel_id, "PA_TOT_PREM_BC"),
                ...
                function (id) {
                    ...
                    var sel_id = grid.jqGrid('getGridParam', 'selrow');
                    var paRiskID = grid.jqGrid('getCell', sel_id, 'PA_SYS_ID');

                    if (paRiskID == $("#PA_SYS_ID").val()) {
                        ...
                        u.growl_warning("No Pa Risk selected, Please check and try again");
        ...
        $scope.riskFees_grid = u.default_grid("#gridCompFees", "#gridCompFeesPager", "Applicable Fees Summary",
            ...
            [
                { name: 'PA_FEE_CODE', index: 'PA_FEE_CODE', width: 150 },
                { name: 'PA_FEE_NAME', index: 'PA_FEE_NAME', width: 200 },
                { name: 'PA_FEE_FC_AMOUNT', index: 'PA_FEE_FC_AMOUNT', width: 150 },
                { name: 'PA_FEE_BC_AMOUNT', index: 'PA_FEE_BC_AMOUNT', width: 150 },

                { name: 'PA_FEE_POL_SYS_ID', index: 'PA_FEE_POL_SYS_ID', width: 150 },
                { name: 'PA_FEE_RK_SYS_ID', index: 'PA_FEE_RK_SYS_ID', width: 150 },
                { name: 'PA_FEE_RK_NO', index: 'PA_FEE_RK_NO', width: 150 },
                { name: 'PA_FEE_RK_CODE', index: 'PA_FEE_RK_CODE', width: 150 },
                { name: 'PA_FEE_END_NO', index: 'PA_FEE_END_NO', width: 150 },
                { name: 'PA_FEE_STATUS', index: 'PA_FEE_STATUS', width: 150 },
                { name: 'PA_FEE_SYS_ID', index: 'PA_FEE_SYS_ID', width: 150 },
            ],
           //Retrive Grid data into form input fields on row click..
            function (sel_id) {
        ...
        // Product Risk Grid ****
        $scope.prodRisks_grid = u.default_grid("#gridProdRisk", "#gridProdRiskPager", "Pa Risk",
            ['Code', 'Name'],
            [
 ...
 *--------------------*/
            ...
            s.getRiskFees(riskFeesData, function (result) {
                if (result && result.length && result.length > 0) {
                    ...
                    for (var i in result) {
                        ...
                        result[i]["PA_FEE_FC_AMOUNT"] = result[i]["PRF_FEE_AMOUNT"];
                        result[i]["PA_FEE_BC_AMOUNT"] = result[i]["PRF_FEE_AMOUNT"];
                        result[i]["PA_FEE_CODE"] = result[i]["PRF_FEE_CODE"];
                        result[i]["PA_FEE_RK_NO"] = result[i]["FEE_NAME"];
                        result[i]["PA_FEE_NAME"] = result[i]["PRF_SYS_ID"];
                        result[i]["PA_FEE_RK_CODE"] = $("#PA_RISK_CODE").val();
                        result[i]["PA_FEE_RK_SYS_ID"] = $("#PA_SYS_ID").val();
                        result[i]["PA_FEE_CRTE_BY"] = "Admin";
                        result[i]["PA_FEE_CRTE_DATE"] = Date.now();
                        result[i]["PA_FEE_STATUS"] = "U";
                        //
                ...
                var result =
                    linq.GroupBy(function (x) { return x.PA_FEE_CODE; })
                        .Select(function (x) {
                            console.log(x);
                            return {
                                POL_FEE_CODE: x.Key(),
                                POL_FEE_NAME: x.source[0]["PA_FEE_NAME"],
                                POL_FEE_FC_AMOUNT: x.Sum(function (y) { return y.PA_FEE_FC_AMOUNT | 0; }),
                                POL_FEE_BC_AMOUNT: x.Sum(function (y) { return y.PA_FEE_BC_AMOUNT | 0; }),
       ...
       *------------------------------------------------*/
                    ...
                    s.getAddRiskCovers(productRiskData, function (result) {
                        if (result && result.length && result.length > 0) {
                            ...
                            for (var i in result) {
                                ...
                                result[i]["RCOV_RI_YN"] = result[i]["MS_UDW_COVERS"]["CVR_RI_PALICABLE"];
                                ...
                                result[i]["RCOV_RISK_SYS_ID"] = $("#PA_SYS_ID").val();
                                result[i]["RCOV_RISK_NO"] = $("#PA_RISK_ID").val();
                                result[i]["RCOV_SI_FC"] = $("#RCOV_SI_FC").val();


                                var deftCoverCode = result[i].RCOV_CODE;
                                var newRiskCode = $("#PA_SYS_ID").val();
        ...
        *------------------------------*/
        ...
        function updateCovers() {
            ...
            if (coverCode == $("#RCOV_SYS_ID").val()) {
                ...
                //
                CURR_RATE = parseFloat($("#PA_CURRENCY_RATE").val()).toFixed(2);
        ...
        *----------------------------------*/
        ...
        $("#").click(function () {
            if (u.form_validation("#polheaderForm")) {
                $("#PaModal").modal();
                $("#PA_CURRENCY").val($("#POLH_CURRENCY").val());
                $("#PA_CURRENCY_RATE").val($("#POLH_CURRENCY_RATE").val());
            }
            else {
        ...
        $("#btn_risk_cover").click(function () {
            ...
            var grid = $("#gridPa");
            var sel_id = grid.jqGrid('getGridParam', 'selrow');
            var RiskID = grid.jqGrid('getCell', sel_id, 'PA_SYS_ID');
            if (RiskID == $("#PA_SYS_ID").val()) {
                //Hide covers not related to selected risk
        ...
        *------------------------------------------------*/
        //
        $("#btn_open_pa").on('click', function () {

            var itemobj = $("#PDT_NAME").val();
            if (itemobj == "") {
                u.growl_warning("No Personal Accident Risk is not Selected");
            }
            else if (itemobj == "INDIVIDUAL") {
                $("#PaModal").modal('show');
                var message = "INDIVIDUAL";
                $("#textmsg").text(message);
                document.getElementById("grpNamed").style.display = 'block';
                document.getElementById("grpUnamed").style.display = 'none';
                $("#PA_RISK_CLASSCODE").val($("#POLH_SUB_CLASS_CODE").val());
                $("#PA_RISK_CLASSNAME").val($("#PDT_NAME").val());
            }
            else if (itemobj == "GROUP NAMED") {
                $("#PaModal").modal('show');
                var message = "GROUP NAMED";
                $("#textmsg").text(message);
                document.getElementById("grpNamed").style.display = 'block';
                document.getElementById("grpUnamed").style.display = 'none';
                $("#PA_RISK_CLASSCODE").val($("#POLH_SUB_CLASS_CODE").val());
            ...
            else if (itemobj == "GROUP UNNAMED") {
                $("#PaModal").modal('show');
                var message = "GROUP UNNAMED";
                $("#textmsg").text(message);
                document.getElementById("grpNamed").style.display = 'none';
                document.getElementById("grpUnamed").style.display = 'block';
                $("#PA_RISK_CLASSCODE").val($("#POLH_SUB_CLASS_CODE").val());
                $("#PA_RISK_CLASSNAME").val($("#PDT_NAME").val());
            }
        });
        ...
        /*--------------------------------------------------
          * Adding Pa Risk Details
          *------------------------------------------------*/
        //
        $("#btn_add_pa").on('click', function () {

            if (u.form_validation("#PaForm")) {
                ...
                if ($("#PA_SYS_ID").val() == "") {
                    RetnSequenceNo("PERSONAL_ACCIDENT_SEQ", getVehSeqNo);
                ...
                u.modal_confirmation("Are you sure you want to add the Pa Details?", function () {

                    var rowIds = $scope.pa_grid.jqGrid('getDataIDs');
                    ...
                    for (var i = 0, len = rowIds.length; i < len; i++) {
                         ...
                         *----------------------------------------------*/
                        //
                        var cellValue = $scope.pa_grid.jqGrid('getCell', currRow, 'PA_SYS_ID');
                     ...
                     *--------------------------------------*/
                    //
                    if ($.inArray($('#PA_SYS_ID').val(), Code) < 0) {

                        var FormData = u.parse_form("#PaForm");
                        FormData.PA_STATUS = "U";
                        FormData.PA_CRTE_BY = "Admin";
                        FormData.PA_CRTE_DATE = u.get_date();
                        //$scope.pa_grid.addRowData(FormData.ID, FormData);
                        $scope.pa_grid.addRowData(FormData.PA_SYS_ID, FormData);
                        //Add defaulf covers afer adding the Risk
                        getDefaultRiskCovers();
                        getRiskComPulsoryFess();
                        u.hide_confirm();
                        u.growl_success("PA successfully added to grid");


                    }
                    else {
                        u.hide_confirm();
                        u.growl_warning("PA with code " + cellValue + " Already exists");
                    }
                });
        ...
        /*----------------------------------------------------
        * Remove record or Mark for deletion from Pa Risk
        *---------------------------------------------------*/
        //
        $("#btn_remove_pa").on('click', function () {

            if (u.grid_empty($scope.pa_grid)) return u.modal_alert("Grid is empty!!!");

            var grid = $scope.pa_grid;

            var row_id = grid.jqGrid('getGridParam', 'selrow');

            var recordStatus = grid.jqGrid('getCell', row_id, 'PA_STATUS');

            var RiskNo = grid.jqGrid('getCell', row_id, 'PA_RISK_ID');
            ...
            u.modal_confirmation("Are you sure you want to remove the Record?", function (e) {
                ...
                if (recordStatus == "A") {
                    ...
                    grid.jqGrid('setCell', row_id, 'PA_STATUS', 'D');
                    $('#' + row_id, '#gridPa').css({ color: 'red' });
                    ...
                    $('#' + row_id, '#gridPa').css({ color: 'black' });
                    grid.jqGrid('setCell', row_id, 'PA_STATUS', 'A');
                    u.hide_confirm();
                    u.growl_hide("Data successfully restored");
                }
        ...
        /*--------------------------------
        * Edit/Update Function Pa Risk Details
        *------------------------------*/
        //
        $("#btn_update_pa").on('click', function () {

            if (u.grid_empty($scope.pa_grid)) return u.growl_info("Pa grid is empty");
            ...
            if (u.form_validation("#PaForm")) {
                ...
                u.modal_confirmation("Are you sure you want to update the selected Motor?", function () {
                    ...
                    var code = grid.jqGrid("getCell", rowId, "PA_RISK_ID");

                    if (code === $("#PA_RISK_ID").val()) {
                        var data = u.parse_form("#PaForm");
                        for (var i in data) {
                            grid.jqGrid("setCell", rowId, i, data[i]);
                        }
                        u.hide_confirm();
                        u.growl_success("Pa Details updated");
                    } else {
                        u.hide_confirm();
                        u.growl_warning("Please select the correct row to edit");
                    }
        ...
        $("#export-bond-btn").click(function () {
             ...
             * function to export grid data into excel
             */
            u.excel_export($scope.pa_grid, ["ID"], "Pa_List_Excel");
        });
        ...
        *----------------------------*/
        ...
        $("#btnApproval").click(function () {
            ...
            u.modal_confirmation("Are you sure you want to Approve ?", function () {
                s.PapolicyApproval({ POL_SYS_ID: $("#POLH_SYS_ID").val(), POL_END_NO: $("#POL_END_NO").val(), TXN_TYPE: 1 }, function (response) {
                    if (response.state) {
        ...
        *------------------*/
        ...
        $("#btn_Reset").on('click', function () {
            u.modal_confirmation("Are you sure you want to clear all data from the form?", function (e) {
                ...
                $scope.pa_grid.jqGrid('clearGridData');
                u.hide_warning();
 ...
 *----------------*/
      ...
      *------------------------------------*/
        ...
        u.set_datepicker("input[name='PA_START_DATE']");
        u.set_datepicker("input[name='PA_END_DATE']");
        ...
        *---------------------------*/
        ...
        function rateFunction() {
            ...
            var NetPremFC = "";
            var NetPremBC = "";
            var ExchangeRate = $('#PA_CURRENCY_RATE').val();
        ...
        *---------------------------*/
        ...
        function fxnPolPeriodDays() {
            ...
            if (polPeriodDays > 0) {
                ...
                $("#PA_PERIOD_DAYS").val(polPeriodDays);
            }
        ...
        //---//Risk period days
        document.getElementById("PA_START_DATE").addEventListener("focusout", fxnRiskPeriodDays);
        document.getElementById("PA_END_DATE").addEventListener("focusout", fxnRiskPeriodDays);
        function fxnRiskPeriodDays() {
            //alert("Input field lost focus.");
            var polStartDate = new Date($("#POLH_POL_START_DATE").val());
            var PolEndDate = new Date($("#POLH_POL_END_DATE").val());

            var riskStartDate = new Date($("#PA_START_DATE").val());
            var riskEndDate = new Date($("#PA_END_DATE").val());
            ...
            if (u.get_dateDifference(polStartDate, riskStartDate) < 0) {
                ...
                if (riskPeriodDays > 0) {
                    $("#PA_PERIOD_DAYS").val(riskPeriodDays);
                }
            }
        ...
        */
        $scope.hideShowCovers = function () {
            ...
            var vehgrid = $scope.pa_grid;
            var selId = vehgrid.jqGrid("getGridParam", "selrow");
            var vehRiskId = vehgrid.jqGrid("getCell", selId, "PA_SYS_ID");
        ...
        $scope.SumCoverRiskValues = function () {
            ...
            var riskId = riskgrid.jqGrid("getCell", riskRowId, "PA_SYS_ID");
            ...
            riskgrid.jqGrid("setCell", riskRowId, "PA_TOT_PREM_FC", sumGrossPremFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PA_TOT_PREM_BC", sumGrossPremBc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "PA_SI_FC", riskSumSifc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PA_SI_BC", riskSumSibc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "PA_LOAD_FC", sumLoadFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PA_LOAD_BC", sumLoadBc.toFixed(2));
        ...
        $scope.SumPolhAmounts = function () {
            ...
            for (var i = 0, len = polrowIds.length; i < len; i++) {
                ...
                polSifc += parseFloat(polgrid.jqGrid('getCell', currRow, "PA_SI_FC"));
                polSibc += parseFloat(polgrid.jqGrid('getCell', currRow, "PA_SI_BC"));

                polGrossPremFc += parseFloat(polgrid.jqGrid('getCell', currRow, "PA_TOT_PREM_FC"));
                polGrossPremBc += parseFloat(polgrid.jqGrid('getCell', currRow, "PA_TOT_PREM_BC"));

                polLoadFc += parseFloat(polgrid.jqGrid('getCell', currRow, "PA_LOAD_FC"));
                polLoadBc += parseFloat(polgrid.jqGrid('getCell', currRow, "PA_LOAD_BC"));

                polDisFc += parseFloat(polgrid.jqGrid('getCell', currRow, "PA_DISC_FC"));
                polDisBc += parseFloat(polgrid.jqGrid('getCell', currRow, "PA_DISC_BC"));
 ...
 *---------------------------*/
        ...
        function handleDOBChanged() {
            $('#PA_DOB').on('change', function () {
                if (isDate($('#PA_DOB').val())) {
                    var age = calculateAge(parseDate($('#PA_DOB').val()), new Date());
                    $('#PA_AGE').val(age);
