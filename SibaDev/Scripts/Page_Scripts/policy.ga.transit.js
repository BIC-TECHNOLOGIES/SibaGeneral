(function ($, s, u, $scope) {
    $(function () {
        ...
        // Bond Risk Grid
        $scope.genaccident_grid = u.default_grid("#gridGa", "#gridGaPager", "General Accident Policy",
               [
                'Reg Code','Reg Name','Area Code','Area Name','Loc Code','Loc Name','Description','Address','Risk Code', 'Risk Name', 'Description',
                 'Currency', 'Currency Rate', 'Start Date', 'End Date', 'Pol Days', 'Uw Year',
                 'Sum Insured FC', 'Sum Insured BC', 'Premium FC', 'Premium BC', 'Limit Loss FC', 'Limit Loss BC', 'Annual Turnover FC', 'Annual Turnover BC',
                'Destination From', 'Destination To', 'Distance','EQ Zone',
                'Sum Insured FC', 'Sum Insured BC', 'Premium FC', 'Premium BC', 'Risk Premium FC', 'Risk Premium BC', 'Adj Premium FC', 'Adj Premium BC',
                'RI Sum Insured FC', 'RI Sum Insured BC', 'RI Premium FC', 'RI Premium BC', 'Discount FC', 'Discount BC', 'Loadings FC', 'Loadings BC', 'Comm FC', 'Comm BC',
               'Created by', 'Created date', 'Sys Id', 'Polh Sys Id', 'Polh Doc No', ' Polh End No'],
            [
                { name: 'TRANS_REGION_CODE', index: 'TRANS_REGION_CODE', width: 100 },
                { name: 'TRANS_REGION_NAME', index: 'TRANS_REGION_NAME', width: 300 },
                { name: 'TRANS_AREA_CODE', index: 'TRANS_AREA_CODE', width: 300 },
                { name: 'TRANS_AREA_NAME', index: 'TRANS_AREA_NAME' },
                { name: 'TRANS_LOC_CODE', index: 'TRANS_LOC_CODE' },
                { name: 'TRANS_LOC_NAME', index: 'TRANS_LOC_NAME' },
                { name: 'TRANS_LOC_DESC', index: 'TRANS_LOC_DESC' },
                { name: 'TRANS_LOC_ADDRS', index: 'TRANS_LOC_ADDRS' },
                { name: 'TRANS_RISK_TYPE', index: 'TRANS_RISK_TYPE', width: 100 },
                { name: 'TRANS_RISK_NAME', index: 'TRANS_RISK_NAME', width: 300 },
                { name: 'TRANS_RISK_DESC', index: 'TRANS_RISK_DESC', width: 300 },

                { name: 'TRANS_CURRENCY', index: 'TRANS_CURRENCY', width: 100 },
                { name: 'TRANS_CURR_RATE', index: 'TRANS_CURR_RATE', width: 300 },
                { name: 'TRANS_START_DATE', index: 'TRANS_START_DATE', width: 100 },
                { name: 'TRANS_END_DATE', index: 'TRANS_END_DATE', width: 300 },
                { name: 'TRANS_PERIOD_DAYS', index: 'TRANS_PERIOD_DAYS', width: 300 },
                { name: 'TRANS_UW_YEAR', index: 'TRANS_UW_YEAR', width: 300 },

                { name: 'TRANS_SUM_INSURED_FC', index: 'TRANS_SUM_INSURED_FC' },
                { name: 'TRANS_SUM_INSURED_BC', index: 'TRANS_SUM_INSURED_BC' },
                { name: 'TRANS_PREMIUM_FC', index: 'TRANS_PREMIUM_FC' },
                { name: 'TRANS_PREMIUM_BC', index: 'TRANS_PREMIUM_BC' },
                { name: 'TRANS_LIMIT_LOSS_FC', index: 'TRANS_LIMIT_LOSS_FC' },
                { name: 'TRANS_LIMIT_LOSS_BC', index: 'TRANS_LIMIT_LOSS_BC', width: 300 },
              
                { name: 'TRANS_ANN_TURNOVER_FC', index: 'TRANS_ANN_TURNOVER_FC', width: 300 },
                { name: 'TRANS_ANN_TURNOVER_BC', index: 'TRANS_ANN_TURNOVER_BC', width: 150 },
                { name: 'TRANS_DENT_FROM', index: 'TRANS_DENT_FROM', width: 150 },
                { name: 'TRANS_DENT_TO', index: 'TRANS_DENT_TO', width: 150 },
                { name: 'TRANS_DISTANCE', index: 'TRANS_DISTANCE', width: 150 },
                { name: 'TRANS_EARTHQ_ZONE', index: 'TRANS_EARTHQ_ZONE', width: 150 },
                { name: 'TRANS_SI_FC', index: 'TRANS_SI_FC', width: 150 },
                { name: 'TRANS_SI_BC', index: 'TRANS_SI_BC', width: 150 },
                { name: 'TRANS_TOT_PREM_FC', index: 'TRANS_TOT_PREM_FC', width: 150 },
                { name: 'TRANS_TOT_PREM_BC', index: 'TRANS_TOT_PREM_BC', width: 150 },
                { name: 'TRANS_RISK_PREM_FC', index: 'TRANS_RISK_PREM_FC', width: 150 },
                { name: 'TRANS_RISK_PREM_BC', index: 'TRANS_RISK_PREM_BC', width: 150 },
                { name: 'TRANS_ADJ_PREM_FC', index: 'TRANS_ADJ_PREM_FC', width: 150 },
                { name: 'TRANS_ADJ_PREM_BC', index: 'TRANS_ADJ_PREM_BC', width: 150 },

                { name: "TRANS_RI_SI_FC", index: "TRANS_RI_SI_FC", width: 150 },
                { name: "TRANS_RI_SI_BC", index: "TRANS_RI_SI_BC", width: 150 },
                { name: "TRANS_RI_PREM_FC", index: "TRANS_RI_PREM_FC", width: 150 },
                { name: "TRANS_RI_PREM_BC", index: "TRANS_RI_PREM_BC", width: 150 },

                { name: 'TRANS_DISC_FC', index: 'TRANS_DISC_FC', width: 150 },
                { name: 'TRANS_DISC_BC', index: 'TRANS_DISC_BC', width: 150 },
                { name: 'TRANS_LOAD_FC', index: 'TRANS_LOAD_FC', width: 300 },
                { name: 'TRANS_LOAD_BC', index: 'TRANS_LOAD_BC', width: 300 },
                { name: 'TRANS_COMM_FC', index: 'TRANS_COMM_FC', width: 300 },
                { name: 'TRANS_COMM_BC', index: 'TRANS_COMM_BC', width: 300 },

                { name: 'TRANS_CRTE_BY', index: 'TRANS_CRTE_BY', width: 150 },
                { name: 'TRANS_CRTE_DATE', index: 'TRANS_CRTE_DATE', width: 150 },
                { name: 'TRANS_SYS_ID', index: 'TRANS_SYS_ID', width: 150 },
                { name: 'TRANS_POLH_SYS_ID', index: 'TRANS_POLH_SYS_ID', width: 150 },
                { name: 'TRANS_POLH_DOC_NO', index: 'TRANS_POLH_DOC_NO', width: 150 },
                { name: 'TRANS_POLH_END_NO', index: 'TRANS_POLH_END_NO', width: 150 },
                //{ name: 'INS_UWD_RISK_COVERS', index: 'INS_UWD_RISK_COVERS', width: 150 },
            ],
            //Retrive Grid data into form input fields on row click..
            function (sel_id) {
                var grid = $scope.genaccident_grid;
                var sel_id = grid.jqGrid('getGridParam', 'selrow');
                $("form input[name='TRANS_SYS_ID']").data("update", true);
                u.fill_form({
                    TRANS_SYS_ID: grid.jqGrid('getCell', sel_id, 'TRANS_SYS_ID'),
                    TRANS_RISK_TYPE: grid.jqGrid('getCell', sel_id, 'TRANS_RISK_TYPE'),
                    TRANS_RISK_NAME: grid.jqGrid('getCell', sel_id, 'TRANS_RISK_NAME'),
                    TRANS_REGION_CODE: grid.jqGrid('getCell', sel_id, 'TRANS_REGION_CODE'),
                    TRANS_REGION_NAME: grid.jqGrid('getCell', sel_id, 'TRANS_REGION_NAME'),
                    TRANS_AREA_CODE: grid.jqGrid('getCell', sel_id, 'TRANS_AREA_CODE'),
                    TRANS_AREA_NAME: grid.jqGrid('getCell', sel_id, 'TRANS_AREA_NAME'),
                    TRANS_LOC_CODE: grid.jqGrid('getCell', sel_id, 'TRANS_LOC_CODE'),
                    TRANS_LOC_NAME: grid.jqGrid('getCell', sel_id, 'TRANS_LOC_NAME'),
                    TRANS_LOC_DESC: grid.jqGrid('getCell', sel_id, 'TRANS_LOC_DESC'),
                    TRANS_LOC_ADDRS: grid.jqGrid('getCell', sel_id, 'TRANS_LOC_ADDRS'),
                    TRANS_EARTHQ_ZONE: grid.jqGrid('getCell', sel_id, 'TRANS_EARTHQ_ZONE'),
                    TRANS_DENT_FROM: grid.jqGrid('getCell', sel_id, 'TRANS_DENT_FROM'),
                    TRANS_DENT_TO: grid.jqGrid('getCell', sel_id, 'TRANS_DENT_TO'),
                    TRANS_DISTANCE: grid.jqGrid('getCell', sel_id, 'TRANS_DISTANCE'),
                    TRANS_LIMIT_LIABILITY: grid.jqGrid('getCell', sel_id, 'TRANS_LIMIT_LIABILITY'),
                    TRANS_LIMIT_OCCUR: grid.jqGrid('getCell', sel_id, 'TRANS_LIMIT_OCCUR'),
                    TRANS_SUM_INSURED: grid.jqGrid('getCell', sel_id, 'TRANS_SUM_INSURED'),
                }, "#genaccidentForm");
                u.fill_form({
                    RCOV_RISK_SYS_ID: grid.jqGrid('getCell', sel_id, 'TRANS_SYS_ID'),
                }, "#coverForm");

                u.fill_form({
                    FINW_ORIG_SI_FC: grid.jqGrid("getCell", sel_id, "TRANS_SI_FC"),
                    FINW_ORIG_SI_BC: grid.jqGrid("getCell", sel_id, "TRANS_SI_BC"),
                    FINW_ORIG_PREM_FC: grid.jqGrid("getCell", sel_id, "TRANS_TOT_PREM_FC"),
                    FINW_ORIG_PREM_BC: grid.jqGrid("getCell", sel_id, "TRANS_TOT_PREM_BC"),
                }, "#facInwardForm");

                u.fill_form({
                    FOTW_SHARE_SI_FC: grid.jqGrid("getCell", sel_id, "TRANS_SI_FC"),
                    FOTW_SHARE_SI_BC: grid.jqGrid("getCell", sel_id, "TRANS_SI_BC"),
                    FOTW_SHARE_PREM_FC: grid.jqGrid("getCell", sel_id, "TRANS_TOT_PREM_FC"),
                    FOTW_SHARE_PREM_BC: grid.jqGrid("getCell", sel_id, "TRANS_TOT_PREM_BC"),
                ...
                function (id) {
                    ...
                    var sel_id = grid.jqGrid('getGridParam', 'selrow');
                    var RiskID = grid.jqGrid('getCell', sel_id, 'TRANS_SYS_ID');

                    if (RiskID == $("#TRANS_SYS_ID").val()) {
        ...
        $scope.riskFees_grid = u.default_grid("#gridCompFees", "#gridCompFeesPager", "Applicable Fees Summary",
            ...
            [
                { name: 'GAR_FEE_CODE', index: 'GAR_FEE_CODE', width: 150 },
                { name: 'GAR_FEE_NAME', index: 'GAR_FEE_NAME', width: 200 },
                { name: 'GAR_FEE_FC_AMOUNT', index: 'GAR_FEE_FC_AMOUNT', width: 150 },
                { name: 'GAR_FEE_BC_AMOUNT', index: 'GAR_FEE_BC_AMOUNT', width: 150 },

                { name: 'GAR_FEE_POL_SYS_ID', index: 'GAR_FEE_POL_SYS_ID', width: 150 },
                { name: 'GAR_FEE_RK_SYS_ID', index: 'GAR_FEE_RK_SYS_ID', width: 150 },
                { name: 'GAR_FEE_RK_NO', index: 'GAR_FEE_RK_NO', width: 150 },
                { name: 'GAR_FEE_RK_CODE', index: 'GAR_FEE_RK_CODE', width: 150 },
                { name: 'GAR_FEE_END_NO', index: 'GAR_FEE_END_NO', width: 150 },
                { name: 'GAR_FEE_STATUS', index: 'GAR_FEE_STATUS', width: 150 },
                { name: 'GAR_FEE_SYS_ID', index: 'GAR_FEE_SYS_ID', width: 150 },
            ],
           //Retrive Grid data into form input fields on row click..
            function (sel_id) {
        ...
        $scope.area_grid = u.default_grid("#gridArea", "#gridAreaPager", "Area",
            ...
            function (sel_id) {
                ...
                var sel_id = grid.jqGrid("getGridParam", "selrow");
                $("form input[name='TRANS_AREA_CODE']").data("update", true);
                u.fill_form({
                    TRANS_AREA_CODE: grid.jqGrid("getCell", sel_id, "ARE_CODE"),
                    TRANS_AREA_NAME: grid.jqGrid("getCell", sel_id, "ARE_NAME"),
        ...
        $scope.loc_grid = u.default_grid("#gridLoc", "#gridLocPager", "Location",
            ...
            function (sel_id) {
                ...
                var sel_id = grid.jqGrid("getGridParam", "selrow");
                $("form input[name='TRANS_LOC_CODE']").data("update", true);
                u.fill_form({
                    TRANS_LOC_CODE: grid.jqGrid("getCell", sel_id, "LOC_CODE"),
                    TRANS_LOC_NAME: grid.jqGrid("getCell", sel_id, "LOC_NAME"),
 ...
 *----------------------------------------*/
        ...
        *------------------------------------------------*/
        ...
        function getAreaLov() {
            ...
            */
            var areaData = {
                PRD_CODE: $("#TRANS_REGION_CODE").val(),
            }; //
            var grid = $scope.area_grid;
            ...
            s.getRiskFees(riskFeesData, function (result) {
                if (result && result.length && result.length > 0) {
                    ...
                    for (var i in result) {
                        ...
                        result[i]["GAR_FEE_FC_AMOUNT"] = result[i]["PRF_FEE_AMOUNT"];
                        result[i]["GAR_FEE_BC_AMOUNT"] = result[i]["PRF_FEE_AMOUNT"];
                        result[i]["GAR_FEE_CODE"] = result[i]["PRF_FEE_CODE"];
                        result[i]["GAR_FEE_RK_NO"] = result[i]["FEE_NAME"];
                        result[i]["GAR_FEE_NAME"] = result[i]["PRF_SYS_ID"];
                        result[i]["GAR_FEE_RK_CODE"] = $("#TRANS_RISK_CODE").val();
                        result[i]["GAR_FEE_RK_SYS_ID"] = $("#TRANS_SYS_ID").val();
                        result[i]["GAR_FEE_CRTE_BY"] = "Admin";
                        result[i]["GAR_FEE_CRTE_DATE"] = Date.now();
                        result[i]["GAR_FEE_STATUS"] = "U";
                        //
                ...
                var result =
                    linq.GroupBy(function (x) { return x.GAR_FEE_CODE; })
                        .Select(function (x) {
                            console.log(x);
                            return {
                                POL_FEE_CODE: x.Key(),
                                POL_FEE_NAME: x.source[0]["GAR_FEE_NAME"],
                                POL_FEE_FC_AMOUNT: x.Sum(function (y) { return y.GAR_FEE_FC_AMOUNT | 0; }),
                                POL_FEE_BC_AMOUNT: x.Sum(function (y) { return y.GAR_FEE_BC_AMOUNT | 0; }),
       ...
       *------------------------------------------------*/
                    ...
                    s.getAddRiskCovers(productRiskData, function (result) {
                        if (result && result.length && result.length > 0) {
                            ...
                            for (var i in result) {
                                ...
                                result[i]["RCOV_RI_YN"] = result[i]["MS_UDW_COVERS"]["CVR_RI_TRANSLICABLE"];
                                ...
                                result[i]["RCOV_RISK_SYS_ID"] = $("#TRANS_SYS_ID").val();
                                result[i]["RCOV_RISK_NO"] = $("#TRANS_RISK_ID").val();
                                result[i]["RCOV_SI_FC"] = $("#RCOV_SI_FC").val();


                                var deftCoverCode = result[i].RCOV_CODE;
                                var newRiskCode = $("#TRANS_SYS_ID").val();
        ...
        *------------------------------*/
        ...
        function updateCovers() {
            ...
            if (coverCode == $("#RCOV_SYS_ID").val()) {
                ...
                //
                CURR_RATE = parseFloat($("#TRANS_CURRENCY_RATE").val()).toFixed(2);
        ...
        *----------------------------------*/
         ...
         *------------------------------------------------*/
        //
        $("#btn_open_ga_risk").click(function () {
            if (u.form_validation("#polheaderForm")) {
                $("#garModal").modal();
                var message = "GOODS/CASH IN TRANSIT";
                $("#textTRANS").text(message);
                $("#TRANS_CURRENCY").val($("#POLH_CURRENCY").val());
                $("#TRANS_CURRENCY_RATE").val($("#POLH_CURRENCY_RATE").val());
                $("#TRANS_RISK_TYPE").val($("#POLH_SUB_CLASS_CODE").val());
                $("#TRANS_RISK_NAME").val($("#PDT_NAME").val());
            }
            else {
        ...
        $("#btn_gar_OnClose").click(function () {

            if (u.grid_empty($scope.genaccident_grid)) {
                u.modal_confirmation("The Grid is empty, do you want to close form?", function (e) {
                    $("#garModal").modal("hide");
                    u.hide_confirm();
                });
        ...
        /*--------------------------------------------------
          * Adding TRANS Risk Details
          *------------------------------------------------*/
        //
        $("#btn_add_garisk").on('click', function () {

            if (u.form_validation("#genaccidentForm")) {

                if ($("#TRANS_RISK_CODE").val() === "") return u.modal_alert("Please Enter Risk No");

                $("#TRANS_SYS_ID").val("");

                if ($("#TRANS_SYS_ID").val() == "") {
                    RetnSequenceNo("INS_UDW_GA_TRANSIT_SEQ", getVehSeqNo);
                ...
                u.modal_confirmation("Are you sure you want to add the Bond Details?", function () {
                    ...
                    var rowIds = $scope.genaccident_grid.jqGrid('getDataIDs');
                    ...
                    for (var i = 0, len = rowIds.length; i < len; i++) {
                         ...
                         *----------------------------------------------*/
                        //
                        var cellValue = $scope.genaccident_grid.jqGrid('getCell', currRow, 'TRANS_SYS_ID');
                     ...
                     *--------------------------------------*/
                    //
                    if ($.inArray($('#TRANS_SYS_ID').val(), Code) < 0) {

                        var FormData = u.parse_form("#genaccidentForm");
                       
                        FormData.TRANS_STATUS = "U";
                        FormData.TRANS_CRTE_BY = "Admin";
                        FormData.TRANS_CRTE_DATE = u.get_date();
                        //$scope.genaccident_grid.addRowData(FormData.ID, FormData);
                        $scope.genaccident_grid.addRowData(FormData.TRANS_SYS_ID, FormData);
                        //Add defaulf covers afer adding the Risk
                        getDefaultRiskCovers();
                        getRiskComPulsoryFess();
                        u.hide_confirm();
                        u.growl_success("TRANS successfully added to grid");


                    }
                    else {
                        u.hide_confirm();
                        u.growl_warning("TRANS with code " + cellValue + " Already exists");
                    }
                });
        ...
        *---------------------------------------------------*/
        //
        $("#btn_remove_garisk").on('click', function () {

            if (u.grid_empty($scope.genaccident_grid)) return u.modal_alert("Grid is empty!!!");
            ...
            var RiskNo = grid.jqGrid('getCell', row_id, 'TRANS_SYS_ID');
        ...
        *------------------------------*/
        //
        $("#btn_update_garisk").on('click', function () {

            if (u.grid_empty($scope.genaccident_grid)) return u.growl_info("Bond grid is empty");
            ...
            if (u.form_validation("#genaccidentForm")) {
                ...
                u.modal_confirmation("Are you sure you want to update the selected Motor?", function () {
                    ...
                    var code = grid.jqGrid("getCell", rowId, "TRANS_SYS_ID");

                    if (code === $("#TRANS_SYS_ID").val()) {
                        var data = u.parse_form("#genaccidentForm");
                        for (var i in data) {
                            grid.jqGrid("setCell", rowId, i, data[i]);
                        }
                        u.hide_confirm();
                        u.growl_success("TRANS Details updated");
                    } else {
                        u.hide_confirm();
                        u.growl_warning("Please select the correct row to edit");
                    }
         ...
         * exporting of the grid to excel Condition & Clauses
         *----------------------------------*/
        $("#export-ga-btn").click(function () {
            /*
             * function to export grid data into excel
             */
            u.excel_export($scope.genaccident_grid, ["ID"], "General_Accident_List_Excel");
        });
        ...
        *----------------------------------*/
        ...
        $("#IntermCommLov").on("click", function () {
            ...
            */
            var interParamData = {
                TRANSD_CODE: $("#POLH_SUB_CLASS_CODE").val(),
            };
        ...
        $("#btn_Save").on('click', function () {
            ...
            if (u.grid_empty($scope.genaccident_grid)) {
                return u.growl_warning("Please add General Accident Details");
            }          
            ...
            u.modal_confirmation("Are you sure you want to save?", function (e) {
                ...
                polhData.INS_UDW_GA_TRANSIT = u.get_grid_data($scope.genaccident_grid);

                var INS_UWD_RISK_COVERS = u.get_grid_data($scope.cover_grid);

                var INS_UDW_GA_RISK_FEES = u.get_grid_data($scope.riskFees_grid);

                for (var i in polhData.INS_UDW_GA_TRANSIT) {
                    //loop through every risk and obtain the sys_id of the risk
                    var id = polhData.INS_UDW_GA_TRANSIT[i]["TRANS_SYS_ID"];

                    polhData.INS_UDW_GA_TRANSIT[i]["INS_UWD_RISK_COVERS"] = [];

                    polhData.INS_UDW_GA_TRANSIT[i]["INS_UDW_GA_RISK_FEES"] = [];
                    ...
                    for (var y in INS_UWD_RISK_COVERS) {
                        ...
                        if (INS_UWD_RISK_COVERS[y]["RCOV_RISK_SYS_ID"] === id) {
                            polhData.INS_UDW_GA_TRANSIT[i]["INS_UWD_RISK_COVERS"].push(INS_UWD_RISK_COVERS[y]);
                        }

                        for (var x in INS_UDW_GA_RISK_FEES) {
                            //find covers which have the same the same risk sys_id
                            if (INS_UDW_GA_RISK_FEES[x]["GA_FEE_RK_SYS_ID"] === id) {
                                polhData.INS_UDW_GA_TRANSIT[i]["INS_UDW_GA_RISK_FEES"].push(INS_UDW_GA_RISK_FEES[x]);
                            }
                        }
                ...
                //polhData.INS_UDW_GA_RISK_FEES = u.get_grid_data($scope.riskFees_grid);
                ...
                if (!$scope.saving) {
                    ...
                    s.save_policy(polhData, function (responseData) {
                        ...
                        if (responseData.state) {
                            ...
                            var riskRowIds = $scope.genaccident_grid.jqGrid("getDataIDs");
                            var covRecStatus;
                            /*---------------------------------
                             * update motor row status
                             *-------------------------------*/
                            for (var i = 0; i < riskRowIds.length; i++) {
                                covRecStatus = $scope.genaccident_grid.jqGrid("getCell", riskRowIds[i], "TRANS_STATUS");

                                //Delete row if it is marked for deletion
                                if (covRecStatus === "D") {
                                    $scope.genaccident_grid.jqGrid("delRowData", riskRowIds[i]);
                                }
                                //Update row status to Active (A) if it is newly added
                                if (covRecStatus === "U") {
                                    $scope.genaccident_grid.jqGrid("setCell", riskRowIds[i], "TRANS_STATUS", "A");
                                }
                            }
        ...
        *----------------------------*/
        ...
        $("#btnEndorse").on('click', function () {
            u.modal_confirmation("Are you sure you want to pass an endorsement on the Policy?", function (e) {
                ...
                for (var i = 0; i < riskRowIds.length; i++) {
                    ...
                    $scope.genaccident_grid.jqGrid("setCell", riskRowIds[i], "TRANS_POLH_END_NO", endNo);
                }
                //Risk Covers
                for (var j = 0; j < coverRowIds.length; j++) {

                    $scope.genaccident_grid.jqGrid("setCell", coverRowIds[j], "RPCOV_END_NO", endNo);
                }
                //Commissions
                ...
                for (var m = 0; m < riskFeesIds.length; m++) {
                    ...
                    $scope.riskFees_grid.jqGrid("setCell", riskFeesIds[m], "GAR_FEE_END_NO", endNo);
                }
                ////Pol fees summary
        ...
        $("#btnApproval").click(function () {
            ...
            u.modal_confirmation("Are you sure you want to Approve ?", function () {
                s.TransitpolicyApproval({ POL_SYS_ID: $("#POLH_SYS_ID").val(), POL_END_NO: $("#POL_END_NO").val(), TXN_TYPE: 1 }, function (response) {
                    if (response.state) {
        ...
        *------------------*/
        ...
        $("#btn_Reset").on('click', function () {
            u.modal_confirmation("Are you sure you want to clear all data from the form?", function (e) {
                ...
                u.form_reset("#genaccidentForm");
                $scope.cover_grid.jqGrid('clearGridData');
                $scope.genaccident_grid.jqGrid('clearGridData');
                u.hide_warning();
 ...
 *----------------*/
        ...
        $scope.search_fill = function (policy) {
            ...
            u.clear_grid_data($scope.genaccident_grid);
            if (policy.INS_UDW_GA_TRANSIT) {
                for (var i in policy.INS_UDW_GA_TRANSIT) {
                    $scope.genaccident_grid.addRowData(policy.INS_UDW_GA_TRANSIT[i].ID, policy.INS_UDW_GA_TRANSIT[i]);
                }
            ...
            //populate risk covers with covers from the GA Transit and not the policy header 
            u.clear_grid_data($scope.cover_grid);
            for (var x in policy.INS_UDW_GA_TRANSIT[i].INS_UWD_RISK_COVERS) {
                //get Cover Names
                policy.INS_UDW_GA_TRANSIT[i].INS_UWD_RISK_COVERS[x]["RCOV_NAME"] = policy.INS_UDW_GA_TRANSIT[i].INS_UWD_RISK_COVERS[x]["MS_UDW_COVERS"]["CVR_NAME"];
                //get Covers
                $scope.cover_grid.addRowData(policy.INS_UDW_GA_TRANSIT[i].INS_UWD_RISK_COVERS[x].RCOV_RISK_SYS_ID, policy.INS_UDW_GA_TRANSIT[i].INS_UWD_RISK_COVERS[x]);
            }
        };
      ...
      *------------------------------------*/
        ...
        u.set_datepicker("input[name='TRANS_START_DATE']");
        u.set_datepicker("input[name='TRANS_END_DATE']");
        u.set_datepicker("input[name='TRANS_START_DATE']");
        u.set_datepicker("input[name='TRANS_END_DATE']");
        ...
        *---------------------------*/
        ...
        function rateFunction() {
            ...
            var NetPremFC = "";
            var NetPremBC = "";
            var ExchangeRate = $('#TRANS_CURRENCY_RATE').val();
        ...
        *---------------------------*/
        ...
        function fxnPolPeriodDays() {
            ...
            $("#TRANS_START_DATE").val(SDate);
            $("#TRANS_END_DATE").val(EDate);
            ...
            if (polPeriodDays > 0) {
                ...
                $("#TRANS_PERIOD_DAYS").val(polPeriodDays);
            }
        ...
        //---//Risk period days
        document.getElementById("TRANS_START_DATE").addEventListener("focusout", fxnRiskPeriodDays);
        document.getElementById("TRANS_END_DATE").addEventListener("focusout", fxnRiskPeriodDays);
        function fxnRiskPeriodDays() {
            //alert("Input field lost focus.");
            var polStartDate = new Date($("#POLH_POL_START_DATE").val());
            var PolEndDate = new Date($("#POLH_POL_END_DATE").val());

            var riskStartDate = new Date($("#TRANS_START_DATE").val());
            var riskEndDate = new Date($("#TRANS_END_DATE").val());
            ...
            if (u.get_dateDifference(polStartDate, riskStartDate) < 0) {
                ...
                if (riskPeriodDays > 0) {
                    $("#TRANS_PERIOD_DAYS").val(riskPeriodDays);
                }
            }
        ...
        */
        $scope.hideShowCovers = function () {
            ...
            var vehgrid = $scope.genaccident_grid;
            var selId = vehgrid.jqGrid("getGridParam", "selrow");
            var vehRiskId = vehgrid.jqGrid("getCell", selId, "TRANS_SYS_ID");
        ...
        $scope.SumCoverRiskValues = function () {
            ...
            //Risk/Bond Grid
            var riskgrid = $scope.genaccident_grid;
            ...
            var riskId = riskgrid.jqGrid("getCell", riskRowId, "TRANS_SYS_ID");
            ...
            riskgrid.jqGrid("setCell", riskRowId, 'TRANS_PREMIUM_FC', sumGrossPremFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "TRANS_TOT_PREM_FC", sumGrossPremFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "TRANS_TOT_PREM_BC", sumGrossPremBc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "TRANS_SUM_INSURED", riskSumSifc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "TRANS_SI_FC", riskSumSifc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "TRANS_SI_BC", riskSumSibc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "TRANS_LOAD_FC", sumLoadFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "TRANS_LOAD_BC", sumLoadBc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "TRANS_DISC_FC", sumDisFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "TRANS_DISC_BC", sumDisBc.toFixed(2));


            // set risk SI and Premiums vlues,

            $('#TRANS_SI_FC').val(riskSumSifc.toFixed(2));
            $('#TRANS_SI_BC').val(riskSumSibc.toFixed(2));

            $('#TRANS_TOT_PREM_FC').val(sumGrossPremFc.toFixed(2));
            $('#TRANS_TOT_PREM_BC').val(sumGrossPremBc.toFixed(2));
            //
            $('#TRANS_LOAD_FC').val(sumLoadFc.toFixed(2));
            $('#TRANS_LOAD_BC').val(sumLoadBc.toFixed(2));

            $('#TRANS_DISC_FC').val(sumDisFc.toFixed(2));
            $('#TRANS_DISC_BC').val(sumDisBc.toFixed(2));
        ...
        $scope.SumPolhAmounts = function () {
            ...
            var polSibc = 0;
            //
            var polgrid = $scope.genaccident_grid;
            ...
            for (var i = 0, len = polrowIds.length; i < len; i++) {
                ...
                polSifc += parseFloat(polgrid.jqGrid('getCell', currRow, "TRANS_SI_FC"));
                polSibc += parseFloat(polgrid.jqGrid('getCell', currRow, "TRANS_SI_BC"));

                polGrossPremFc += parseFloat(polgrid.jqGrid('getCell', currRow, "TRANS_TOT_PREM_FC"));
                polGrossPremBc += parseFloat(polgrid.jqGrid('getCell', currRow, "TRANS_TOT_PREM_BC"));

                polLoadFc += parseFloat(polgrid.jqGrid('getCell', currRow, "TRANS_LOAD_FC"));
                polLoadBc += parseFloat(polgrid.jqGrid('getCell', currRow, "TRANS_LOAD_BC"));

                polDisFc += parseFloat(polgrid.jqGrid('getCell', currRow, "TRANS_DISC_FC"));
                polDisBc += parseFloat(polgrid.jqGrid('getCell', currRow, "TRANS_DISC_BC"));
            ...
            //
            $("#TRANS_AGGRET_LIMIT").val(polSifc);
            $("#TRANS_AGGRET_LIMIT1").val(polSibc);

            $("#TRANS_LIMIT_OCCUR").val(polSifc);
            $("#TRANS_LIMIT_OCCUR1").val(polSibc);

            $("#TRANS_PREM_FC").val(polGrossPremFc);
            $("#TRANS_PREM_BC").val(polGrossPremBc);
        ...
        /*
       Get default covers for the first time of loading the Risk Covers 
        */
