    ...
    $(function () {
        ...
        $scope.genaccident_grid = u.default_grid("#gridGa", "#gridGaPager", "General Accident Policy",
            ...
            [
                ...
                { name: 'PRO_AGGRET_LIMIT_FC', index: 'PRO_AGGRET_LIMIT_FC', width: 100 },
                { name: 'PRO_AGGRET_LIMIT_BC', index: 'PRO_AGGRET_LIMIT_BC' },
                { name: 'PRO_LIMIT_OCCUR_FC', index: 'PRO_LIMIT_OCCUR_FC' },

                { name: 'PRO_LIMIT_OCCUR_BC', index: 'PRO_LIMIT_OCCUR_BC', width: 100 },
                { name: 'PRO_PREM_FC', index: 'PRO_PREM_FC', width: 300 },
                { name: 'PRO_PREM_BC', index: 'PRO_PREM_BC', width: 300 },

                { name: 'PRO_CURRENCY', index: 'PRO_CURRENCY', width: 100 },
                { name: 'PRO_CURR_RATE', index: 'PRO_CURR_RATE', width: 300 },
                { name: 'PRO_START_DATE', index: 'PRO_START_DATE', width: 100 },
                { name: 'PRO_END_DATE', index: 'PRO_END_DATE', width: 300 },
                { name: 'PRO_PERIOD_DAYS', index: 'PRO_PERIOD_DAYS', width: 300 },
                { name: 'PRO_UW_YEAR', index: 'PRO_UW_YEAR', width: 300 },
        ...
        $("#btn_Save").on('click', function () {
            ...
            if (Pol_Txn_State === "" || Pol_Txn_State === "S") {
                ...
                u.modal_confirmation("Are you sure you want to save?", function (e) {
                    ...
                    polhData.INS_UDW_PRO_RISK_FEES = u.get_grid_data($scope.riskFees_grid);
                        ...
                        s.save_policy(polhData, function (responseData) {
                            ...
                            if (responseData.state) {
                                ...
                                for (var i = 0; i < bondRowIds.length; i++) {
                                    covRecStatus = $scope.genaccident_grid.jqGrid("getCell", bondRowIds[i], "PRO_STATUS");
                                    ...
                                    if (covRecStatus === "U") {
                                        $scope.genaccident_grid.jqGrid("setCell", bondRowIds[i], "PRO_STATUS", "A");
                                    }
                                }
        ...
        $("#btnEndorse").on('click', function () {
            u.modal_confirmation("Are you sure you want to pass an endorsement on the Policy?", function (e) {
                ...
                for (var i = 0; i < bondRowIds.length; i++) {
                    ...
                    $scope.genaccident_grid.jqGrid("setCell", bondRowIds[i], "PRO_POLH_END_NO", 22);
                }
                //Risk Covers
