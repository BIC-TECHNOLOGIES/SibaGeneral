(function ($, s, u, $scope) {
    $(function () {
        ...
        $scope.genaccident_grid = u.default_grid("#gridGa", "#gridGaPager", "General Accident Policy",
               [
                'Item Code', 'Item Name', 'Aggregate Limit FC', 'Aggregate Limit BC', 'Limit Occurance FC','Limit Occurance BC', 'Premium FC', 'Premium BC',
                 'Currency','Currency Rate','Start Date','End Date','Pol Days','Uw Year','Sum Insured FC', 'Sum Insured BC', 'Premium FC', 'Premium BC', 
                'Risk Premium FC', 'Risk Premium BC', 'Adj Premium FC', 'Adj Premium BC','RI Sum Insured FC', 'RI Sum Insured BC', 'RI Premium FC', 'RI Premium BC',
                'Discount FC', 'Discount BC', 'Loadings FC', 'Loadings BC', 'Comm FC', 'Comm BC',
                'Created by', 'Created date', 'Status', 'Sys Id', 'Polh Sys Id', 'Polh Doc No', ' Polh End No'],
            [
                { name: 'PRO_ITEM', index: 'PRO_ITEM', width: 100 },
                { name: 'PRO_ITEM_DESC', index: 'PRO_ITEM_DESC', width: 300 },
                { name: 'PRO_AGGRET_LIMIT_FC', index: 'PRO_AGGRET_LIMIT_FC', width: 150 },
                { name: 'PRO_AGGRET_LIMIT_BC', index: 'PRO_AGGRET_LIMIT_BC', width: 150 },
                { name: 'PRO_LIMIT_OCCUR_FC', index: 'PRO_LIMIT_OCCUR_FC', width: 150 },

                { name: 'PRO_LIMIT_OCCUR_BC', index: 'PRO_LIMIT_OCCUR_BC', width: 150 },
                { name: 'PRO_PREM_FC', index: 'PRO_PREM_FC', width: 150 },
                { name: 'PRO_PREM_BC', index: 'PRO_PREM_BC', width: 150 },

                { name: 'PRO_CURRENCY', index: 'PRO_CURRENCY', width: 150 },
                { name: 'PRO_CURR_RATE', index: 'PRO_CURR_RATE', width: 150 },
                { name: 'PRO_START_DATE', index: 'PRO_START_DATE', width: 150 },
                { name: 'PRO_END_DATE', index: 'PRO_END_DATE', width: 150 },
                { name: 'PRO_PERIOD_DAYS', index: 'PRO_PERIOD_DAYS', width: 150 },
                { name: 'PRO_UW_YEAR', index: 'PRO_UW_YEAR', width: 150 },
             
                { name: 'PRO_SI_FC', index: 'PRO_SI_FC', width: 150 },
                { name: 'PRO_SI_BC', index: 'PRO_SI_BC', width: 150 },
                { name: 'PRO_TOT_PREM_FC', index: 'PRO_TOT_PREM_FC', width: 150 },
                { name: 'PRO_TOT_PREM_BC', index: 'PRO_TOT_PREM_BC', width: 150 },
                { name: 'PRO_RISK_PREM_FC', index: 'PRO_RISK_PREM_FC', width: 150 },
                { name: 'PRO_RISK_PREM_BC', index: 'PRO_RISK_PREM_BC', width: 150 },
                { name: 'PRO_ADJ_PREM_FC', index: 'PRO_ADJ_PREM_FC', width: 150 },
                { name: 'PRO_ADJ_PREM_BC', index: 'PRO_ADJ_PREM_BC', width: 150 },

                { name: "PRO_RI_SI_FC", index: "PRO_RI_SI_FC", width: 150 },
                { name: "PRO_RI_SI_BC", index: "PRO_RI_SI_BC", width: 150 },
                { name: "PRO_RI_PREM_FC", index: "PRO_RI_PREM_FC", width: 150 },
                { name: "PRO_RI_PREM_BC", index: "PRO_RI_PREM_BC", width: 150 },

                { name: 'PRO_DISC_FC', index: 'PRO_DISC_FC', width: 150 },
                { name: 'PRO_DISC_BC', index: 'PRO_DISC_BC', width: 150 },
                { name: 'PRO_LOAD_FC', index: 'PRO_LOAD_FC', width: 300 },
                { name: 'PRO_LOAD_BC', index: 'PRO_LOAD_BC', width: 300 },
                { name: 'PRO_COMM_FC', index: 'PRO_COMM_FC', width: 300 },
                { name: 'PRO_COMM_BC', index: 'PRO_COMM_BC', width: 300 },

                { name: 'PRO_CRTE_BY', index: 'PRO_CRTE_BY', width: 150 },
                { name: 'PRO_CRTE_DATE', index: 'PRO_CRTE_DATE', width: 150 },
                { name: 'PRO_STATUS', index: 'PRO_STATUS', width: 150 },
                { name: 'PRO_SYS_ID', index: 'PRO_SYS_ID', width: 150 },
                { name: 'PRO_POLH_SYS_ID', index: 'PRO_POLH_SYS_ID', width: 150 },
                { name: 'PRO_POLH_DOC_NO', index: 'PRO_POLH_DOC_NO', width: 150 },
                { name: 'PRO_POLH_END_NO', index: 'PRO_POLH_END_NO', width: 150 },
            ...
            function (sel_id) {
                ...
                $("form input[name='PRO_SYS_ID']").data("update", true);
                u.fill_form({
                    PRO_SYS_ID: grid.jqGrid('getCell', sel_id, 'PRO_SYS_ID'),
                    PRO_ITEM: grid.jqGrid('getCell', sel_id, 'PRO_ITEM'),
                    PRO_ITEM_DESC: grid.jqGrid('getCell', sel_id, 'PRO_ITEM_DESC'),
                    PRO_AGGRET_LIMIT_FC: grid.jqGrid('getCell', sel_id, 'PRO_AGGRET_LIMIT_FC'),
                    PRO_AGGRET_LIMIT_BC: grid.jqGrid('getCell', sel_id, 'PRO_AGGRET_LIMIT_BC'),
                    PRO_LIMIT_OCCUR_FC: grid.jqGrid('getCell', sel_id, 'PRO_LIMIT_OCCUR_FC'),
                    PRO_LIMIT_OCCUR_BC: grid.jqGrid('getCell', sel_id, 'PRO_LIMIT_OCCUR_BC'),
                    PRO_PREM_FC: grid.jqGrid('getCell', sel_id, 'PRO_PREM_FC'),
                    PRO_PREM_BC: grid.jqGrid('getCell', sel_id, 'PRO_PREM_BC'),
                }, "#genaccidentForm");
                u.fill_form({
                    RCOV_RISK_SYS_ID: grid.jqGrid('getCell', sel_id, 'PRO_SYS_ID'),
                }, "#coverForm");

                u.fill_form({
                    FINW_ORIG_SI_FC: grid.jqGrid("getCell", sel_id, "PRO_SI_FC"),
                    FINW_ORIG_SI_BC: grid.jqGrid("getCell", sel_id, "PRO_SI_BC"),
                    FINW_ORIG_PREM_FC: grid.jqGrid("getCell", sel_id, "PRO_TOT_PREM_FC"),
                    FINW_ORIG_PREM_BC: grid.jqGrid("getCell", sel_id, "PRO_TOT_PREM_BC"),
                }, "#facInwardForm");

                u.fill_form({
                    FOTW_SHARE_SI_FC: grid.jqGrid("getCell", sel_id, "PRO_SI_FC"),
                    FOTW_SHARE_SI_BC: grid.jqGrid("getCell", sel_id, "PRO_SI_BC"),
                    FOTW_SHARE_PREM_FC: grid.jqGrid("getCell", sel_id, "PRO_TOT_PREM_FC"),
                    FOTW_SHARE_PREM_BC: grid.jqGrid("getCell", sel_id, "PRO_TOT_PREM_BC"),
                ...
                function (id) {
                    ...
                    var sel_id = grid.jqGrid('getGridParam', 'selrow');
                    var bondRiskID = grid.jqGrid('getCell', sel_id, 'PRO_SYS_ID');

                    if (bondRiskID == $("#PRO_SYS_ID").val()) {
            ...
            s.getRiskFees(riskFeesData, function (result) {
                if (result && result.length && result.length > 0) {
                    ...
                    for (var i in result) {
                        ...
                        result[i]["GAR_FEE_RK_CODE"] = $("#PRO_RISK_CODE").val();
                        result[i]["GAR_FEE_RK_SYS_ID"] = $("#PRO_SYS_ID").val();
       ...
       *------------------------------------------------*/
                    ...
                    s.getAddRiskCovers(productRiskData, function (result) {
                        if (result && result.length && result.length > 0) {
                            ...
                            for (var i in result) {
                                ...
                                result[i]["RCOV_RI_YN"] = result[i]["MS_UDW_COVERS"]["CVR_RI_PROLICABLE"];
                                ...
                                result[i]["RCOV_RISK_SYS_ID"] = $("#PRO_SYS_ID").val();
                                result[i]["RCOV_RISK_NO"] = $("#PRO_RISK_ID").val();
                                result[i]["RCOV_SI_FC"] = $("#RCOV_SI_FC").val();


                                var deftCoverCode = result[i].RCOV_CODE;
                                var newRiskCode = $("#PRO_SYS_ID").val();
        ...
        *------------------------------*/
        ...
        function updateCovers() {
            ...
            if (coverCode == $("#RCOV_SYS_ID").val()) {
                ...
                //
                CURR_RATE = parseFloat($("#PRO_CURRENCY_RATE").val()).toFixed(2);
        ...
        *----------------------------------*/
        ...
        $("#btn_open_ga_risk").click(function () {
            if (u.form_validation("#polheaderForm")) {
                $("#garModal").modal();
                var message = "PROFESSIONAL INDEMNITY";
                $("#textGA").text(message);
                $("#PRO_CURRENCY").val($("#POLH_CURRENCY").val());
                $("#PRO_CURRENCY_RATE").val($("#POLH_CURRENCY_RATE").val());
            }
            else {
        ...
        $("#btn_risk_cover").click(function () {
            ...
            var grid = $scope.genaccident_grid;
            var selId = grid.jqGrid("getGridParam", "selrow");
            var RiskId = grid.jqGrid("getCell", selId, "PRO_SYS_ID");

            if (RiskId == $("#PRO_SYS_ID").val()) {
        ...
        $("#btn_add_garisk").on('click', function () {
            ...
            if (u.form_validation("#genaccidentForm")) {
                ...
                if ($("#PRO_ITEM").val() === "") return u.modal_alert("Please Enter Item");

                $("#PRO_SYS_ID").val("");

                if ($("#PRO_SYS_ID").val() == "") {
                    RetnSequenceNo("INS_UDW_GA_PROF_INDEMNITY_SEQ", getVehSeqNo);
                ...
                u.modal_confirmation("Are you sure you want to add the Professional Indemnity Details?", function () {
                    ...
                    for (var i = 0, len = rowIds.length; i < len; i++) {
                         ...
                         *----------------------------------------------*/
                        //
                        var cellValue = $scope.genaccident_grid.jqGrid('getCell', currRow, 'PRO_SYS_ID');
                     ...
                     *--------------------------------------*/
                    //
                    if ($.inArray($('#PRO_SYS_ID').val(), Code) < 0) {
                        ...
                        $scope.genaccident_grid.addRowData(FormData.PRO_SYS_ID, FormData);
                        //Add defaulf covers afer adding the Risk
                        getDefaultRiskCovers();
                        getRiskComPulsoryFess();
                        u.hide_confirm();
                        u.growl_success("PRO successfully added to grid");


                    }
                    else {
                        u.hide_confirm();
                        u.growl_warning("PRO with code " + cellValue + " Already exists");
                    }
                });
        ...
        *---------------------------------------------------*/
        ...
        $("#btn_remove_garisk").on('click', function () {
            ...
            var RiskNo = grid.jqGrid('getCell', row_id, 'PRO_SYS_ID');
        ...
        $("#btn_update_garisk").on('click', function () {
            ...
            if (u.form_validation("#genaccidentForm")) {
                ...
                u.modal_confirmation("Are you sure you want to update the selected Motor?", function () {
                    ...
                    var code = grid.jqGrid("getCell", rowId, "PRO_SYS_ID");

                    if (code === $("#PRO_SYS_ID").val()) {
                        var data = u.parse_form("#genaccidentForm");
                        for (var i in data) {
                            grid.jqGrid("setCell", rowId, i, data[i]);
                        }
                        u.hide_confirm();
                        u.growl_success("PRO Details updated");
                    } else {
                        u.hide_confirm();
                        u.growl_warning("Please select the correct row to edit");
                    }
        ...
        *----------------------------------*/
        ...
        $("#btn_Save").on('click', function () {
            ...
            u.modal_confirmation("Are you sure you want to save?", function (e) {
                ...
                polhData.INS_UDW_GA_PROF_INDEMNITY = u.get_grid_data($scope.genaccident_grid);

                var INS_UWD_RISK_COVERS = u.get_grid_data($scope.cover_grid);

                var INS_UDW_GA_RISK_FEES = u.get_grid_data($scope.riskFees_grid);

                for (var i in polhData.INS_UDW_GA_PROF_INDEMNITY) {
                    //loop through every risk and obtain the sys_id of the risk
                    var id = polhData.INS_UDW_GA_PROF_INDEMNITY[i]["PRO_SYS_ID"];

                    polhData.INS_UDW_GA_PROF_INDEMNITY[i]["INS_UWD_RISK_COVERS"] = [];

                    polhData.INS_UDW_GA_PROF_INDEMNITY[i]["INS_UDW_GA_RISK_FEES"] = [];
                    ...
                    for (var y in INS_UWD_RISK_COVERS) {
                        ...
                        if (INS_UWD_RISK_COVERS[y]["RCOV_RISK_SYS_ID"] === id) {
                            polhData.INS_UDW_GA_PROF_INDEMNITY[i]["INS_UWD_RISK_COVERS"].push(INS_UWD_RISK_COVERS[y]);
                        }

                        for (var x in INS_UDW_GA_RISK_FEES) {
                            //find covers which have the same the same risk sys_id
                            if (INS_UDW_GA_RISK_FEES[x]["GAR_FEE_RK_SYS_ID"] === id) {
                                polhData.INS_UDW_GA_PROF_INDEMNITY[i]["INS_UDW_GA_RISK_FEES"].push(INS_UDW_GA_RISK_FEES[x]);
                            }
                        }
                    }
                    ...
                    s.save_policy(polhData, function (responseData) {
                        ...
                        if (responseData.state) {
                            ...
                            for (var i = 0; i < riskRowIds.length; i++) {
                                covRecStatus = $scope.genaccident_grid.jqGrid("getCell", riskRowIds[i], "PRO_STATUS");
                                ...
                                if (covRecStatus === "U") {
                                    $scope.genaccident_grid.jqGrid("setCell", riskRowIds[i], "PRO_STATUS", "A");
                                }
                            }
        ...
        *----------------------------*/
        ...
        $("#btnEndorse").on('click', function () {
            u.modal_confirmation("Are you sure you want to pass an endorsement on the Policy?", function (e) {
                ...
                for (var i = 0; i < riskRowIds.length; i++) {
                    ...
                    $scope.genaccident_grid.jqGrid("setCell", riskRowIds[i], "PRO_POLH_END_NO", endNo);
                }
                //Risk Covers
        ...
        $("#btnApproval").click(function () {
            ...
            u.modal_confirmation("Are you sure you want to Approve ?", function () {
                s.ProfIndemnitypolicyApproval({ POL_SYS_ID: $("#POLH_SYS_ID").val(), POL_END_NO: $("#POL_END_NO").val(), TXN_TYPE: 1 }, function (response) {
                    if (response.state) {
 ...
 *----------------*/
        ...
        $scope.search_fill = function (policy) {
            ...
            if (policy.INS_UDW_GA_PROF_INDEMNITY) {
                for (var i in policy.INS_UDW_GA_PROF_INDEMNITY) {
                    $scope.genaccident_grid.addRowData(policy.INS_UDW_GA_PROF_INDEMNITY[i].ID, policy.INS_UDW_GA_PROF_INDEMNITY[i]);
            ...
            //populate risk covers with covers from the GA Professional Indemnity and not the policy header
            u.clear_grid_data($scope.cover_grid);
            for (var x in policy.INS_UDW_GA_PROF_INDEMNITY[i].INS_UWD_RISK_COVERS) {
                //get Cover Names
                policy.INS_UDW_GA_PROF_INDEMNITY[i].INS_UWD_RISK_COVERS[x]["RCOV_NAME"] = policy.INS_UDW_GA_PROF_INDEMNITY[i].INS_UWD_RISK_COVERS[x]["MS_UDW_COVERS"]["CVR_NAME"];
                //get Covera
                $scope.cover_grid.addRowData(policy.INS_UDW_GA_PROF_INDEMNITY[i].INS_UWD_RISK_COVERS[x].RCOV_RISK_SYS_ID, policy.INS_UDW_GA_PROF_INDEMNITY[i].INS_UWD_RISK_COVERS[x]);
            }
        };
      ...
      *------------------------------------*/
        ...
        u.set_datepicker("input[name='PRO_START_DATE']");
        u.set_datepicker("input[name='PRO_END_DATE']");
        u.set_datepicker("input[name='PRO_START_DATE']");
        u.set_datepicker("input[name='PRO_END_DATE']");
        ...
        *---------------------------*/
        ...
        function rateFunction() {
            ...
            var NetPremFC = "";
            var NetPremBC = "";
            var ExchangeRate = $('#PRO_CURRENCY_RATE').val();
        ...
        *---------------------------*/
        ...
        function fxnPolPeriodDays() {
            ...
            $("#PRO_START_DATE").val(SDate);
            $("#PRO_END_DATE").val(EDate);
            ...
            if (polPeriodDays > 0) {
                ...
                $("#PRO_PERIOD_DAYS").val(polPeriodDays);
            }
        ...
        //---//Risk period days
        document.getElementById("PRO_START_DATE").addEventListener("focusout", fxnRiskPeriodDays);
        document.getElementById("PRO_END_DATE").addEventListener("focusout", fxnRiskPeriodDays);
        function fxnRiskPeriodDays() {
            //alert("Input field lost focus.");
            var polStartDate = new Date($("#POLH_POL_START_DATE").val());
            var PolEndDate = new Date($("#POLH_POL_END_DATE").val());

            var riskStartDate = new Date($("#PRO_START_DATE").val());
            var riskEndDate = new Date($("#PRO_END_DATE").val());
            ...
            if (u.get_dateDifference(polStartDate, riskStartDate) < 0) {
                ...
                if (riskPeriodDays > 0) {
                    $("#PRO_PERIOD_DAYS").val(riskPeriodDays);
                }
            }
        ...
        */
        $scope.hideShowCovers = function () {
            ...
            var vehRiskId = vehgrid.jqGrid("getCell", selId, "PRO_SYS_ID");
        ...
        $scope.SumCoverRiskValues = function () {
            ...
            var riskId = riskgrid.jqGrid("getCell", riskRowId, "PRO_SYS_ID");
            ...
            riskgrid.jqGrid("setCell", riskRowId, 'PRO_PREMIUM_FC', sumGrossPremFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PRO_TOT_PREM_FC", sumGrossPremFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PRO_TOT_PREM_BC", sumGrossPremBc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "PRO_SUM_INSURED", riskSumSifc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PRO_SI_FC", riskSumSifc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PRO_SI_BC", riskSumSibc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "PRO_LOAD_FC", sumLoadFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PRO_LOAD_BC", sumLoadBc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "PRO_DISC_FC", sumDisFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PRO_DISC_BC", sumDisBc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "PRO_AGGRET_LIMIT_FC", riskSumSifc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PRO_AGGRET_LIMIT_BC", riskSumSifc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "PRO_LIMIT_OCCUR_FC", riskSumSifc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PRO_LIMIT_OCCUR_BC", riskSumSifc.toFixed(2));

            riskgrid.jqGrid("setCell", riskRowId, "PRO_PREM_FC", sumGrossPremFc.toFixed(2));
            riskgrid.jqGrid("setCell", riskRowId, "PRO_PREM_BC", sumGrossPremBc.toFixed(2));

            //
            $('#PRO_AGGRET_LIMIT_FC').val(riskSumSifc.toFixed(2));
            $('#PRO_AGGRET_LIMIT_BC').val(riskSumSibc.toFixed(2));

            $('#PRO_LIMIT_OCCUR_FC').val(riskSumSifc.toFixed(2));
            $('#PRO_LIMIT_OCCUR_BC').val(riskSumSibc.toFixed(2));

            $('#PRO_PREM_FC').val(sumGrossPremFc.toFixed(2));
            $('#PRO_PREM_BC').val(sumGrossPremBc.toFixed(2));
        ...
        $scope.SumPolhAmounts = function () {
            ...
            for (var i = 0, len = polrowIds.length; i < len; i++) {
                ...
                polSifc += parseFloat(polgrid.jqGrid('getCell', currRow, "PRO_SI_FC"));
                polSibc += parseFloat(polgrid.jqGrid('getCell', currRow, "PRO_SI_BC"));

                polGrossPremFc += parseFloat(polgrid.jqGrid('getCell', currRow, "PRO_TOT_PREM_FC"));
                polGrossPremBc += parseFloat(polgrid.jqGrid('getCell', currRow, "PRO_TOT_PREM_BC"));

                polLoadFc += parseFloat(polgrid.jqGrid('getCell', currRow, "PRO_LOAD_FC"));
                polLoadBc += parseFloat(polgrid.jqGrid('getCell', currRow, "PRO_LOAD_BC"));

                polDisFc += parseFloat(polgrid.jqGrid('getCell', currRow, "PRO_DISC_FC"));
                polDisBc += parseFloat(polgrid.jqGrid('getCell', currRow, "PRO_DISC_BC"));
